...
public class OrderMain {
    public static void main(String[] args) {
        ...
        Order order1 = new Order(123025,"Max Musterman",20.36,"Ожидает");
        Order order2 = new Order(123027,"Maxime Musterman",29.37,"Отправлен");
        Order order3 = new Order(123031,"Kaplan Kasim",45.01,"Доставлен");

    }

  //  static double calculateFinalAmount(double taxRate, double discountPercentage) {
