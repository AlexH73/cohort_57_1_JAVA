...
public class MapOperationsDemo {
    public static void main(String[] args) {
        ...
        phoneBook.put("Иван", "+7-900-123-45-67");
        phoneBook.put("Мария", "+7-901-234-56-78");
        phoneBook.put("Алексей", "+7-902-345-67-89");
        ...
        phoneBook.put("Иван", "+7-900-999-99-99");
        ...
        // 8. Проверка наличия значения (есть ли номер "+7-900-999-99-99")
        System.out.println("Есть ли номер +7-900-999-99-99 в списке? " + phoneBook.containsValue("+7-900-999-99-99"));
