...
public class TeacherCode46 {
    public static void main(String[] args) throws InterruptedException {
        ...
        if (thread1.isAlive()) {
            ...
            thread1.join(3000);
            // существует два способа остановить поток:
            // метод  stop() - устаревший метод, который помечен аннотацией @Depricated,
            // он слишком топорно выключит поток, что может привести к ошибкам дальнейшего выполнения приложения
            //thread1.stop();
