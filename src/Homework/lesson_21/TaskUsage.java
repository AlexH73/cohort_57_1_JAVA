...
public class TaskUsage {
     ...
     *     1. Добавить поле priority (целое число), которое обозначает
     *     приоритет задачи (чем меньше число, тем выше приоритет).<br>
     *     2. Реализовать метод isHighPriority(), который возвращает true,
     *     если приоритет задачи меньше 3, и false в противном случае.<br>
     *     3. В методе displayTask() добавить вывод приоритета и его
     *     классификацию (например, "Высокий", "Средний", "Низкий").<br>
