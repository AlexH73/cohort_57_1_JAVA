...
public class Store22Test {
    public static void main(String[] args) {
        ...
        ProductTemp orange = new ProductTemp(1.9, "orange");
        ...
        //Arrays.copyOf(массив, размер) - создаст копию массива "массив"с указанным количеством ячеек
        // "размер", в нашем примере, увеличит размер на 1
