...
public class ColorImageGenerator3 {
...
// * @param fileName имя выходного файла, например "color.jpg"
    ...
    public static void saveRainbowCheckerboardImage(String fileName) {
        try {
            ...
            for (int x = 0; x < 300; x++) {
                for (int y = 0; y < 300; y++) {
                    // Berechnung der Farbe basierend auf Position im Schachbrett
                    int colorIndex = ((x / squareSize) + (y / squareSize)) % colors.length;
            ...
            System.out.println("Regenbogen-Schachbrettbild gespeichert: " + outputFile.getAbsolutePath());
    ...
    public static void main(String[] args) {
        saveRainbowCheckerboardImage("rainbow_checkerboard.jpg");
    }
