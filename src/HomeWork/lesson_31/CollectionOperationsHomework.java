...
public interface CollectionOperationsHomework {
    ...
    List<Integer> intersectionOfIntegerList(List<Integer> list1, List<Integer> list2);

    List<Integer> unionOfIntegerList(List<Integer> list1, List<Integer> list2);

    List<Integer> differenceOfIntegerList(List<Integer> list1, List<Integer> list2);
    ...
    List<String> intersectionOfStringList(List<String> list1, List<String> list2);

    List<String> unionOfStringList(List<String> list1, List<String> list2);

    List<String> differenceOfStringList(List<String> list1, List<String> list2);
