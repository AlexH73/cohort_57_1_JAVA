...
Copy
Инструкции:
Просмотрите поля в каждом классе и решите, какие из них должны быть private, protected или public.
Подумайте, какие поля следует скрыть (private), а какие оставить доступными.
Отредактируйте классы, добавив модификаторы доступа.
